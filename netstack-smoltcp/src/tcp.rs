...
// NOTE: Default buffer increased to 1 MB for high-speed throughput and window scaling
const DEFAULT_TCP_SEND_BUFFER_SIZE: u32 = 1024 * 1024;
const DEFAULT_TCP_RECV_BUFFER_SIZE: u32 = 1024 * 1024;
